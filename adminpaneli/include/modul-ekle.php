<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Yeni Sayfa Ekleme </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
	  ...
	  if($_POST)
	  {
		  ...
		  if($calistir!=false)
		  {
			  echo '<div class="alert alert-success">Sayfanız başarıyla eklenmiştir.</div>';
			  ?>
		  ...
		  {
			  echo '<div class="alert alert-danger">Sayfanız Eklenirken  hatayla karşılaştı. Hatalar şunlar olabilir.<br>
