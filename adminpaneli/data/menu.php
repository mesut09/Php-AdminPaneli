...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=SITE?>" class="brand-link">
      <img src="<?=SITE?>dist/img/1" class="brand-image img-circle elevation-1"
           style="opacity: .9">
      <span class="brand-text font-weight-cyan">Bilge Elektronik</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?=SITE?>dist/img/12" class="img-circle elevation-1" alt="User Image">
        </div>
        <div class="info">
